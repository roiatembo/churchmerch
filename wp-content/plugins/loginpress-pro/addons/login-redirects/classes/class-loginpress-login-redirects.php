		...
		public function loginpress_login_redirects_autocomplete_js() {
			...
			<script type="text/javascript">
				...
				jQuery(document).ready(function($) {
					...
					var hintMessage = $(`<div class="hintMessage" style="color: red; padding-top: 10px; display: none;">Enter at least ${min_length} characters</div>`);
					var noUsersMessage = $('<div class="noUsersMessage" style="color: red; padding-top: 10px; display: none;">No users found</div>');
