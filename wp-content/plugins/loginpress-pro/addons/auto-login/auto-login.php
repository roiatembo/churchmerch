			...
			<script type="text/javascript">
				...
				jQuery(document).ready(function($) {
					...
					function loginpress_expiration() {
						<?php
						$date           = gmdate( 'Y-m-d' );
						$default_expire = gmdate( 'Y-m-d', strtotime( "$date +8 day" ) ); // PHP Date style:  yy-mm-dd.
					...
					var hintMessage = $(`<div id="hintMessage" style="color: red; padding-top: 10px; display: none;">Enter at least ${min_length} characters</div>`);
					var noUsersMessage = $('<div id="noUsersMessage" style="color: red; padding-top: 10px; display: none;">No users found</div>');
