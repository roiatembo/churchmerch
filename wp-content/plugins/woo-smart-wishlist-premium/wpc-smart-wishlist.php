		...
		if ( ! class_exists( 'WPCleverWoosw' ) ) {
			class WPCleverWoosw {
				...
				function __construct() {
					...
					// add note
					add_action( 'wc_ajax_woosw_add_note', [ $this, 'ajax_add_note' ] );

					// manage wishlists
					add_action( 'wc_ajax_woosw_manage_wishlists', [ $this, 'ajax_manage_wishlists' ] );

					// view wishlist
					add_action( 'wc_ajax_woosw_view_wishlist', [ $this, 'ajax_view_wishlist' ] );

					// add wishlist
					add_action( 'wc_ajax_woosw_add_wishlist', [ $this, 'ajax_add_wishlist' ] );

					// delete wishlist
					add_action( 'wc_ajax_woosw_delete_wishlist', [ $this, 'ajax_delete_wishlist' ] );

					// set default
					add_action( 'wc_ajax_woosw_set_default', [ $this, 'ajax_set_default' ] );
