...
class Woolentor_Wl_Myaccount_Register_Form_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'form_heading',
                [
                    'label' => __( 'Form Heading', 'woolentor-pro' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__('Register','woolentor-pro'),
                    'label_block' => true,
                ]
            );

            $this->add_control(
                'form_heading_html_tag',
                [
                    'label'   => __( 'Form Heading HTML Tag', 'woolentor-pro' ),
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                array(
                    ...
                    'selector'  => '{{WRAPPER}} .woolentor-myaccount-form-register .woolentor-form-title',
                )
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-myaccount-form-register .woolentor-form-title' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-myaccount-form-register .woolentor-form-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default'   => 'left',
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-myaccount-form-register .woolentor-form-title' => 'text-align: {{VALUE}}',
                    ],
                ]
            );
    ...
    protected function render() {
        ...
        $heading_html_tag = woolentor_validate_html_tag( $settings['form_heading_html_tag'] );
        $heading = !empty( $settings['form_heading'] ) ? esc_html( $settings['form_heading'] ) : '';

        if ( Plugin::instance()->editor->is_edit_mode() ) {
            ?>
            <div class="woolentor-myaccount-form-register">

                <?php echo !empty($heading) ? sprintf( "<%s class='woolentor-form-title'>%s</%s>", $heading_html_tag, $heading, $heading_html_tag ) : ''; ?>
