...
class Woolentor_Wl_Thankyou_Order_Details_Widget extends Widget_Base {
            ...
            $this->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'one' => esc_html__( 'Style One', 'woolentor-pro' ),
                    ]
                ]
            );
    ...
    protected function render() {
        ...
        $layout_style = $settings['layout_style'] == '' ? 'default' : $settings['layout_style'];
        
        ?>
        <section class="woocommerce-order-details">
            <?php do_action( 'woocommerce_order_details_before_order_table', $order ); ?>
        
            <h2 class="woocommerce-order-details__title"><?php echo apply_filters('woolentor_order_details_txt', __( 'Order details', 'woolentor-pro' ) ); ?></h2>
        
            <table class="woocommerce-table woocommerce-table--order-details shop_table order_details woolentor-thankyou-order-details-style-<?php echo esc_attr( $layout_style ); ?>">
                <?php if( $settings['layout_style'] == 'one' ): ?>
                <thead>
                    <tr>
                        <th class="woocommerce-table__product-image product-image"><?php esc_html_e( '', 'woolentor-pro' ); ?></th>
                        <th class="woocommerce-table__product-name product-name"><?php esc_html_e( 'Product', 'woolentor-pro' ); ?></th>
                        <th class="woocommerce-table__product-price product-price"><?php esc_html_e( 'Price', 'woolentor-pro' ); ?></th>
                        <th class="woocommerce-table__product-quantity product-quantity"><?php esc_html_e( 'Quantity', 'woolentor-pro' ); ?></th>
                        <th class="woocommerce-table__product-total product-total"><?php esc_html_e( 'Total', 'woolentor-pro' ); ?></th>
                    </tr>
                </thead>
                    ...
                    <?php
                        ...
                        foreach ( $order_items as $item_id => $item ) {
                            ...
                            wc_get_template( 'order/order-details-item.php', array(
                                ...
                                'product'            => $product,
                            ), 'wl-woo-templates', WOOLENTOR_ADDONS_PL_PATH_PRO . 'wl-woo-templates/' );
                        }
                ...
                <tfoot>
                    ...
                    <?php if ( $order->get_customer_note() ) : ?>
                        <tr>
                            <th colspan="3"><?php esc_html_e( 'Note:', 'woolentor-pro' ); ?></th>
