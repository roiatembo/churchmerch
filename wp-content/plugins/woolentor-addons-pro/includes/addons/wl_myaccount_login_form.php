        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' => esc_html__('Login','woolentor-pro'),
                    'label_block' => true,
                ]
            );
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                array(
                    ...
                    'selector'  => '{{WRAPPER}} .woolentor-myaccount-form-login .woolentor-form-title',
                )
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-myaccount-form-login .woolentor-form-title' => 'color: {{VALUE}}',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'size_units' => [ 'px', 'em', '%' ],
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-myaccount-form-login .woolentor-form-title' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                    ],
                ]
            );
            ...
            $this->add_responsive_control(
                ...
                [
                    ...
                    'default'   => 'left',
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-myaccount-form-login .woolentor-form-title' => 'text-align: {{VALUE}}',
                    ],
                ]
            );
