    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'table_subtotal',
                [
                    'label' => __( 'Subtotal', 'woolentor-pro' ),
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Subtotal', 'woolentor-pro' ),
                    'label_block' => false,
                    'condition' => [
                        'style!' => '',
                    ],
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'default' => __( 'Total', 'woolentor-pro' ),
                    'label_block' => false,
                    'condition' => [
                        'style!' => '',
                    ],
            ...
            $this->add_control(
                'price_show_option',
                [
                    'label' => esc_html__( 'Product Price Display Type', 'woolentor-pro' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'unitprice',
                    'options' => [
                        'unitprice' => esc_html__( 'Unit Price', 'woolentor-pro' ),
                        'subtotal'  => esc_html__( 'SubTotal', 'woolentor-pro' ),
                    ],
                    'label_block' => true,
                    'condition' => [
                        'style' => '1',
            ...
            $this->add_control(
                'show_reguler_price',
                [
                    'label' => __( 'Show Regular Price', 'woolentor-pro' ),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __( 'Yes', 'woolentor-pro' ),
                    'label_off' => __( 'No', 'woolentor-pro' ),
                    'condition' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_group_control(
                ...
                array(
                    ...
                    'label'     => __( 'Typography', 'woolentor-pro' ),
                    'selector'  => '{{WRAPPER}} .woolentor-product-price-value del',
                )
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::COLOR,
                    'selectors' => [
                        '{{WRAPPER}} .woolentor-product-price-value del' => 'color: {{VALUE}}',
                    ],
                    'separator' => 'after',
                ]
            );
            ...
            if( $style ){
                ...
                <div id="order_review" class="<?php echo esc_attr(implode(' ', $wrapper_class)) ?>">
                    <div class="woolentor-review-order-inner">
                        <h3 id="order_review_heading" class="order_review_heading"><?php echo esc_html( $title ); ?></h3>
