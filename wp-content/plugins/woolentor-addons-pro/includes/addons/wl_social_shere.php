    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'options' => [
                        ...
                        'WhatsApp' => __( 'WhatsApp', 'woolentor-pro' ),
                        'instagram' => __( 'instagram', 'woolentor-pro' ),
                    ],
                ]
            );
            ...
            $repeater->add_control(
                'instagramusername',
                [
                    'label' => __( 'Instagram Username', 'woolentor-pro' ),
                    'type' => Controls_Manager::TEXT,
                    'description'=>__( 'Username of the Instagram account you want to redirect users to, on clicking the button', 'woolentor-pro'),
                    'condition'=>[
                ...
                <div class="woolentor_product_social_share <?php echo $settings['social_share_layout_style']; ?>">
                    ...
                    <ul>
                        <?php foreach($settings['product_social_share_list'] as $share_item):
                            ...
                            if( $share_item['social_name'] === 'instagram'){
