    ...
    class Popup_Rules_Checker_Pro extends Popup_Rules_Checker{
        ...
        */
        public function check_advanced_rules( $popup_id = 0 ){
            ...
            $metabox_obj = method_exists('Woolentor\Modules\Popup_Builder\Admin\Manage_Metabox','instance') ? Manage_Metabox::instance() : Manage_Metabox::get_instance();

            $popup_meta               = get_post_meta($popup_id, '_wlpb_popup_seetings', true);
            $advanced_rules_defaults  = $metabox_obj->get_default_values('advanced_fields');
            $popup_meta_advaced_rules =  [];
